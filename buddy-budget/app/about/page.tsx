...
import { GithubIcon, HeartFilledIcon, ChartIcon, TrendingIcon, TargetIcon, PiggyBankIcon, WalletIcon, ReceiptIcon } from "@/components/icons";
...
export default function AboutPage() {
  ...
  const timeline = [
    {
      year: "2024",
      title: "Project Birth",
      description: "Buddy Budget was born from a personal need to track and grow net worth with transparency, powerful predictions, and comprehensive asset management.",
    },
    {
      year: "2025",
      title: "Open Source Launch",
      description: "Released as open source to help everyone track and grow their net worth with accessible, transparent tools and accurate predictions.",
    },
    {
      year: "Future",
      title: "Growing Together",
      description: "Building a community-driven platform with comprehensive net worth management features requested by users who want to build wealth.",
    },
  ];
  ...
  const values = [
    {
      title: "Powerful",
      description: "Advanced financial modeling with Monte Carlo simulations and real-time market data integration.",
      emoji: "⚡",
      gradient: "from-brand-blue-400 to-brand-blue-600",
    },
    {
      title: "Ready to Use",
      description: "Cloud-hosted and ready to go. No setup, no installation—just sign up and start tracking your net worth.",
      emoji: "🚀",
      gradient: "from-brand-gold-400 to-brand-gold-600",
    },
    {
      title: "Accessible",
      description: "Net worth tracking tools should be available to everyone, not just those who can afford expensive software.",
      emoji: "🌍",
      gradient: "from-brand-blue-500 to-brand-gold-500",
    },
    {
      title: "Community Driven",
      description: "Built by the community, for the community. Every feature and improvement comes from real user needs.",
      emoji: "🤝",
  ...
  return (
    <div className="flex flex-col gap-20 py-8 md:py-12 relative overflow-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center gap-8 text-center px-4 min-h-[60vh]">
        ...
        <TextReveal delay={0.1}>
          <p className={subtitle({ class: "mt-4 max-w-3xl mx-auto" })}>
            A cloud-hosted net worth tracking and management platform built with passion and
            the belief that everyone deserves access to powerful, ready-to-use financial tools.
          </p>
        </TextReveal>
      </section>
        ...
        >
          <div className="text-center mb-12">
            <h2 className={title({ size: "md" })}>
              The <span className={title({ color: "blue", size: "md" })}>Mission</span>
            </h2>
          </div>
          ...
          <Card className="bg-gradient-to-br from-default-50 to-transparent dark:from-default-50/5 border border-brand-blue-500/20 dark:border-brand-blue-400/20">
            <CardBody className="p-8 md:p-12">
              <p className="text-lg leading-relaxed text-default-700 dark:text-default-300 mb-6">
                Buddy Budget was created with a singular focus: to provide comprehensive, ready-to-use
                tools for tracking and managing your net worth. Too often, powerful net worth tracking
                tools are locked behind expensive paywalls or require complex setup. I believe that
                understanding and growing your net worth should be simple, accessible, and powerful.
              </p>
              <p className="text-lg leading-relaxed text-default-700 dark:text-default-300 mb-6">
                This cloud-hosted platform combines advanced financial modeling techniques—including
                Monte Carlo simulations for net worth predictions, real-time asset tracking with Yahoo
                Finance, and comprehensive portfolio management—with modern web technologies to create
                an intuitive, powerful net worth companion that's ready to use right out of the box.
              </p>
              <p className="text-lg leading-relaxed text-default-700 dark:text-default-300">
                Track your assets, monitor your investments, predict your future net worth—all with
                institutional-grade tools in a simple, accessible platform. No installation, no setup,
                just powerful net worth tracking. That's the Buddy Budget promise.
              </p>
            </CardBody>
          </Card>
        </motion.div>
      ...
      <section className="relative flex flex-col items-center gap-12 px-4">
        ...
        >
          <h2 className={title({ size: "md" })}>
            Powerful <span className={title({ color: "blue", size: "md" })}>Features</span>
          </h2>
        ...
        <FeatureSection className="w-full">
          ...
          <LargeFeatureCard
            ...
            icon={<PiggyBankIcon size={40} className="text-brand-gold-500" />}
            image={
      ...
      <section className="relative flex flex-col items-center gap-12 px-4">
        ...
        >
          <h2 className={title({ size: "md" })}>
            Core <span className={title({ color: "yellow", size: "md" })}>Values</span>
          </h2>
          <p className={subtitle({ class: "mt-2" })}>
              ...
              <Card className="h-full bg-gradient-to-br from-default-50 to-transparent dark:from-default-50/5 border border-brand-blue-500/20 dark:border-brand-blue-400/20 hover:border-brand-blue-500/40 dark:hover:border-brand-blue-400/40 transition-all">
                <CardBody className="p-6">
                  <div className="flex items-start gap-4">
                    <div className={`text-4xl flex-shrink-0 p-3 rounded-xl bg-gradient-to-br ${value.gradient} shadow-lg`}>
                      {value.emoji}
                    </div>
                    <div>
      ...
      <section className="relative flex flex-col items-center gap-12 px-4">
        ...
        >
          <h2 className={title({ size: "md" })}>
            The <span className={title({ color: "blue", size: "md" })}>Journey</span>
          </h2>
          <p className={subtitle({ class: "mt-2" })}>
      ...
      <section className="relative flex flex-col items-center gap-12 px-4">
        ...
        >
          <h2 className={title({ size: "md" })}>
            Built with Modern{" "}
            <span className={title({ color: "yellow", size: "md" })}>Technology</span>
          </h2>
          <p className={subtitle({ class: "mt-2" })}>
              ...
              <Card className="bg-gradient-to-br from-default-50 to-transparent dark:from-default-50/5 border border-brand-blue-500/20 dark:border-brand-blue-400/20 hover:border-brand-blue-500/40 dark:hover:border-brand-blue-400/40 transition-all">
                <CardBody className="px-4 py-2">
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-xs text-default-500">{tech.category}</span>
                  </div>
                </CardBody>
              </Card>
            </motion.div>
      ...
      <section className="relative flex flex-col items-center gap-8 px-4">
        ...
        >
          <h2 className={title({ size: "md" })}>
            About the{" "}
            <span className={title({ color: "blue", size: "md" })}>Creator</span>
          </h2>
          <Card className="mt-8 bg-gradient-to-br from-default-50 to-transparent dark:from-default-50/5 border border-brand-blue-500/20 dark:border-brand-blue-400/20">
            <CardBody className="p-8 md:p-12 text-left">
              <p className="text-lg leading-relaxed text-default-700 dark:text-default-300 mb-6">
                Hi, I'm Daniele Roccaforte! I'm a software developer based in Turin, Italy—a city
                known for its rich history, incredible coffee culture, and stunning views of the Alps.
                When I'm not coding or hiking in the nearby mountains, I'm diving deep into financial
                markets and building tools that help people take control of their wealth.
              </p>
              <p className="text-lg leading-relaxed text-default-700 dark:text-default-300 mb-6">
                Buddy Budget started as a personal challenge: I wanted to track my own net worth with
                precision, predict future growth using data science, and monitor my investments in
                real-time. After months of building features for myself, I realized this could help
                others who share the same frustration with expensive, complicated financial tools that
                require extensive setup.
              </p>
              <p className="text-lg leading-relaxed text-default-700 dark:text-default-300 mb-6">
                With a background in software engineering and a passion for financial independence,
                I combined modern web technologies with advanced statistical methods to create a
                cloud-hosted platform that's ready to use immediately. From Monte Carlo simulations
                that predict your financial future to real-time portfolio tracking powered by market
                APIs, every feature is designed with one goal: helping you understand exactly where
                your wealth is and where it's going.
              </p>
              <p className="text-lg leading-relaxed text-default-700 dark:text-default-300">
                I'm a firm believer in open source and the power of community. Buddy Budget is my
                contribution to making wealth-building accessible to everyone, regardless of where
                you live or what you earn. Whether you're in Turin, Tokyo, or Texas, powerful net
                worth tracking should be just a click away. Let's build the future of net worth
                tracking together!
              </p>
            </CardBody>
          </Card>
      ...
      <section className="relative flex flex-col items-center gap-6 text-center px-4 py-20 my-8">
        ...
        >
          ...
          <p className={subtitle({ class: "mt-4 mb-8 max-w-2xl" })}>
            Whether you're tracking your net worth with Buddy Budget or contributing to its development,
            you're part of a community building better wealth management tools for everyone.
          </p>
