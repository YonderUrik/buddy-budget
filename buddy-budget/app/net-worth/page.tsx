      ...
      <section className="relative flex flex-col items-center justify-center gap-8 text-center px-4">
        ...
        <TextReveal delay={0.1}>
          <p className={subtitle({ class: "mt-4 max-w-3xl mx-auto" })}>
            Predict your future net worth using advanced Monte Carlo simulations.
            Get realistic forecasts based on your income, savings, and investment returns.
          </p>
        </TextReveal>
      </section>
      ...
      <section className="relative flex flex-col items-center gap-12 px-4">
        ...
        >
          <h2 className={title({ size: "md" })}>
            How It <span className="bg-gradient-to-r from-brand-blue-500 to-brand-gold-500 bg-clip-text text-transparent">Works</span>
          </h2>
        ...
        <FeatureSection className="w-full">
          ...
          <FeatureCard
            ...
            description={<p className="text-sm text-default-600">Instead of giving you just one prediction, we run thousands of different scenarios (simulations) to show you the range of possible outcomes. Think of it like rolling dice thousands of times to understand all the ways your investments might perform. Markets don't move in straight lines—some years are great, others are terrible. Monte Carlo helps you see the full picture.</p>}
            icon={<DiceIcon size={32} className="text-brand-blue-500" />}
          />

          {/* Box-Muller Transform */}
          <FeatureCard
            title="Box-Muller Transform"
            description={<p className="text-sm text-default-600">This mathematical technique converts random numbers into realistic market returns that follow a 'bell curve' distribution—just like real market behavior. Most returns cluster around the average, with occasional extreme highs and lows. Instead of unrealistic coin-flip randomness, we simulate market behavior that mirrors historical patterns: most months near average, occasional big swings.</p>}
            icon={<BarChartIcon size={32} className="text-brand-gold-500" />}
          />
          ...
          <FeatureCard
            ...
            description={
              <div className="space-y-3">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-default-600">Pessimistic (10th Percentile)</p>
                ...
                <div className="flex gap-3">
                  <div className="w-3 h-3 rounded-full bg-brand-blue-500 mt-1 flex-shrink-0"></div>
                  <div>
                    <p className="text-sm font-semibold text-default-600">Realistic (50th Percentile - Median)</p>
                    <p className="text-sm text-default-600">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-default-600">Optimistic (90th Percentile)</p>
                    <p className="text-sm text-default-600">
            ...
            icon={<ChartIcon size={32} className="text-brand-blue-500" />}
          />
            ...
            description={
              <div className="space-y-2">
                ...
                <div className="bg-default-100 rounded-lg p-3 mt-2">
                  <p className="text-sm"><strong>Example:</strong> At 2% inflation, $100,000 in 20 years
                    will only buy what $67,297 buys today. We account for this automatically.</p>
                </div>
              </div>
            }
            icon={<DollarIcon size={32} className="text-brand-gold-500" />}
          />
          ...
          <FeatureCard
            ...
            icon={<ActivityIcon size={32} className="text-brand-blue-500" />}
          />
          ...
          <FeatureCard
            ...
            icon={<AlertIcon size={32} className="text-warning-600" />}
          />
        </FeatureSection>
      </section>
    </div>
