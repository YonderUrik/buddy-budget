...
export default function TermsPage() {
  ...
  const sections = Array.from({ length: 10 }, (_, i) => i + 1).map(num => ({
    id: `section${num}`,
    title: t(`legal.termsSection${num}`),
  }));
            ...
            {sections.map((section, index) => (
              ...
              >
                ...
                <div className="mt-4 text-muted-foreground leading-relaxed">
                  <p>
                    {t(`legal.termsSection${index + 1}Desc`, { 
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-6">
              ...
              <Link href={paths.privacy} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                {t("legal.privacyPolicy")}
              </Link>
              <Link href={paths.terms} className="text-sm font-medium text-foreground">
